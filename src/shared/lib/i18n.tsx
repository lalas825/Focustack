...
const translations = {
  en: {
    ...
    "project.targetHours": "Weekly target (hours)",
    "project.edit": "Edit",
    "project.complete": "Complete",
    "project.completed": "COMPLETED",
    "project.delete": "Delete",
    "project.confirmDelete": "Delete this project? This cannot be undone.",
    "project.confirmDeleteBtn": "Delete",
    ...
    "error.projectUpdate": "Failed to update project",
    "error.projectComplete": "Failed to complete project",
  ...
  es: {
    ...
    "project.editProject": "EDITAR PROYECTO",
    "project.targetHours": "Meta semanal (horas)",
    "project.edit": "Editar",
    "project.complete": "Completar",
    "project.completed": "COMPLETADO",
    "project.delete": "Eliminar",
    "project.confirmDelete": "Eliminar este proyecto? No se puede deshacer.",
    "project.confirmDeleteBtn": "Eliminar",
    "project.showAll": "Ver todas",
    "project.collapse": "Colapsar",
    ...
    "error.projectUpdate": "No se pudo actualizar el proyecto",
    "error.projectComplete": "No se pudo completar el proyecto",
